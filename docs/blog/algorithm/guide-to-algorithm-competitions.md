...
在这节中，我会先介绍一下各类比赛，以及oier，acmer等概念。
...
> ccpc和icpc类似，我就一起介绍了。每年的网络赛是在8,9的时候，打的好就会给你去区域赛（分站赛）的名额。如果学校没打出名额，分站赛有时候主办方也会施舍一点名额。比如南京站的时候，给省内大学都发了一个名额。然后你来到了区域赛，每年区域赛会有很多个站，比如去年icpc就有杭州站，南京站，西安站等。只要在某一站打的比较好，就有去打亚洲区域赛的资格（EC final）。如果你能拿到金牌区，那就可能直接保送世界决赛（world final）。ccpc的分站赛，决赛和这个差不多。
...
[灵茶山艾府](https://space.bilibili.com/206214?spm_id_from=333.999.0.0)我灵伟大，无需多言。如果你打力扣，那必看灵神！
...
[英雄哥的专栏](https://blog.csdn.net/whereisherofrom/category_9273531.html)999.98元的价格，慎入
