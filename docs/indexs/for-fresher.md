...
专享校园网、有线宽带的账号为你开通的手机号，密码是不同的。无线的校园网只要发条短信就可以修改密码（随机 6 位数字，无法自定义，不是验证码！可以重复用！）有线网则需要打移动的电话查询客服/直接修改或向 10086 发送短信 密码重置 然后选择自己需要的重置内容（重置宽带密码）。有线网默认经过一些处理，他们会告诉你需要通过“宽带上网助手”这种弱智老旧软件才能连，刚开启电脑那一会还会莫名反复断开。（无法连接至远程服务器大概率是把无线网密码当有线网的了）若不想使用这种垃圾，有 2 种方法：

1.使用 OSSA 的 [CMCC-fucker](https://github.com/CCZU-OSSA/cmcc-fucker-rs)
...
如果你需要设置**路由器上网**，[这里](https://www.bilibili.com/video/BV1GH4y1H75S) 有相关教程（仅移动，电信由于魔改拨号协议无法设置路由器上网）
...
7 号楼上下铺，桌子上方有挡板挡视野，暴力拆它丫的！有独立卫浴。 10 号楼上下铺，无挡板，无独浴有独卫。

可容纳较低支架或升降支架低档位的 27 寸屏幕。若不拆挡板视野极差。
